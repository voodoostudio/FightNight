...
return [
    ...
    'title'                 => 'Titre',
    'newspaper_name'        => 'Titre de l\'actualité',
    ...
    // About page
//    'about_text1'           => 'Créée en 2013 la FIGHT NIGHT de Saint-Tropez est un évènement devenu incontournable, alliant les plus hautes valeurs des sports de combat internationaux au caractère authentique de ce village de pêcheurs, mondialement connu et apprécié depuis longtemps par les artistes et la jet set internationale Unité de lieu et de temps, la FIGHT NIGHT vous donne rendez-vous chaque 4 Août à la Citadelle de Saint-Tropez, un monument classé datant du XVIIème siècle. Dans une ambiance festive et raffinée, certains des plus grands noms de la Boxe Thaï et du Kick-Boxing se sont affrontés sur ce ring, faisant désormais partie de la légende des boxes. ',
//    'about_text2'           => 'Chaque année, plus de 1700 spectateurs et des personnalités internationales prennent place parmi une centaine de tables VIP, disposées autour du ring avec vue sur la mer, pour admirer un spectacle 360° unique au monde.',
    'about_title'           => 'Fight Night VI',
    'about_text'            => '<p>Une soirée sportive et glamour exceptionnelle dans un lieu magique !</p>
                                <h3>SUR LE RING</h3>
    ...
    'about_title2'          => 'LA 6ème EDITION',
    'about_tickets_part1'   => 'Ne vous le faites pas raconter : venez vivre l\'évènement en direct !',
    'about_tickets_link'    => 'Mise en vente des billets le 25 avril 2018',
    'about_tickets_part2'   => 'A tous nos fans et invités de prestige, nous souhaitons une excellente Fight Night 6 !',
    ...
    'historical_partners'   => 'Partenaires historiques',
    ...
    'send'                  => 'Envoyer',
    'select_option1'        => 'Presse',
    'select_option2'        => 'Billetterie',
    'select_option3'        => 'Partenaires',
    'select_option4'        => 'Informations Générales',
    'contact_data'          => '<p class="address">
    ...
    // Editions
    'editions_title'        => '<span class="city">Saint-Tropez</span> Fight Night <span class="year">2017</span>',
    'results'               => 'Résultats',
    ...
    // Presse
    'presse'                => 'Presse',
    'in_presse'             => 'La presse en parle',
    'site_mail'             => 'info@fightnights.pro',

    // Results Content
    'results_content_1'     => '<h1 class="title--translated">Résultats 2013</h1>
    ...
    'results_content_2'     => '<h1 class="title--translated">Résultats 2014</h1>
    ...
    'return'                => 'Retour aux editions',

    'results_content_3'     => '<h1 class="title--translated">Résultats 2015</h1>
                    <h3>KICK-BOXING</h3>
                    <p>
                        75KG<br>
    ...
    'results_content_4'     => '<h1 class="title--translated">Résultats 2016</h1>
    ...
    'results_content_5'     => '<h1 class="title--translated">Résultats 2017</h1>
