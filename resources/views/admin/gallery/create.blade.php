            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="title_container">
                            ...
                            <a class="action_link" href="{{ URL::to($lang . '/admin/gallery') }}"><i class="icn icon-arrow_left"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="outer_block_container">
                    <div class="inner_block_container">
                        <form method="POST" id="articleEditForm" action = "{{ route('gallery.store') }}" enctype="multipart/form-data" style = "background: #272727; border: none;">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
