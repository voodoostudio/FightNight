    ...
    <section class="about_section">
        <div class="container-fluid">
            ...
            <div class="about_container jeans_bg">
                ...
                <p>Chaque année, plus de 1700 spectateurs et des personnalités internationales prennent place parmi une centaine de tables VIP, disposées autour du ring avec vue sur la mer, pour admirer un spectacle 360° unique au monde.</p>
            </div>
        </div>
    </section>
@stop
