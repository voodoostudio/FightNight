        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link {{ (Route::getCurrentRoute()->uri == 'gallery' || Route::getCurrentRoute()->uri == $lang . '/galleries' || strpos(url()->current(), 'gallery/details')) ? 'active' : '' }}" href="{{ route('galleries') }}">{{ trans('lang.gallery') }}</a>
